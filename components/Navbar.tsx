...
export default function HaitiNationalResetPage() {
  ...
  const authorities = [
    {
      ...
      text: "Environmental protection, watershed protection, coastal-zone policy, mangrove protection, and restoration planning.",
    },
    {
      title: "Ministry of Agriculture",
      text: "Fisheries, agriculture, aquaculture, farmer support, food production, and food security programs.",
    },
    {
      title: "SEMANAH",
      text: "Maritime navigation, sea safety, boat monitoring, and lawful maritime reporting.",
    },
    {
      title: "Haitian Coast Guard",
      text: "Maritime law enforcement, sea safety, rescue operations, and lawful response to illegal activity at sea.",
    },
    {
      title: "AGD Customs",
      text: "Ports, cargo, illegal imports, exports, customs records, and border accountability.",
    },
    {
      title: "DGI",
      text: "Fiscal identity, business verification, tax records, property records, and revenue accountability.",
    },
    {
      title: "CSCCA",
      text: "Public audits, state accounts, PetroCaribe records, public contracts, and public-money review.",
    },
    {
      title: "Municipalities",
      text: "Building permits, local land use, sanitation, inspections, and local enforcement.",
    },
    {
      title: "Civil Protection",
      text: "Disaster risk, flood risk, emergency planning, evacuation, and public safety warnings.",
    },
    {
      title: "Courts",
      text: "Legal disputes, corruption cases, land cases, illegal construction cases, and due process.",
    },
    {
      title: "Independent Anti-Corruption Court Proposal",
      text: "Public money cases, asset recovery, sanctions follow-up, legal referrals, and independent judgment.",
    },
  ];
  ...
  const resetCouncil = [
    ...
    },
    {
      ...
      text: "Farming, aquaculture, seed banks, food markets, food inspection, farmer cooperatives, and local food security.",
    },
    {
      title: "Land and Housing Commission",
      text: "Illegal construction review, riverbank protection, coastal setback, flood-zone relocation, safe housing plans, and permit tracking.",
    },
    {
      title: "Public Money Commission",
      text: "CSCCA reports, PetroCaribe, earthquake aid, public contracts, DGI records, customs records, and public spending reviews.",
    },
    {
  ...
  return (
    <main className="page">
      ...
      <section className="hero">
        <h1>Legal Rule for Houses Near Sea, Rivers, Ravines and Flood Zones</h1>
      ...
      <section className="hero">
        ...
        <p>
          No illegal construction should continue to destroy riverbanks,
          coastlines, drainage systems, flood zones, and public land. Every
          construction near the sea, rivers, ravines, and canals must be
          reviewed by lawful authorities with safety, environment, land title,
          and human dignity in mind.
        </p>

        <p>
          All accusations of stolen public money must go before independent
          courts using real evidence: CSCCA reports, DGI records, customs
          records, public contracts, banking records obtained legally, donor
